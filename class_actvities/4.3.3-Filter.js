...
const data = [
  ...
  const incompleteTasks = data.filter(tasks => 
    tasks.completed < 1);
...
//   const user6Tasks = data.filter(user => task.userId === 6
//   );
//   const user6Tasks = data.filter(
//       task.userId === 6);
//     console.log(user6Tasks);
const userSix = data.filter(task => task.userID === 6
    );
  ...
  const shortTitles = data.filter(task =>
